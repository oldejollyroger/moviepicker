...
const MovieCardContent = ({ movie, details, isFetching, t, userRegion }) => { /* Unchanged from your script */ };
...
const App = () => {
    ...
    const [filters, setFilters] = useState(() => {
        ...
        if (savedFilters) { try { return { ...initialFilters, ...JSON.parse(savedFilters) }; } catch (e) { return initialFilters; } }
