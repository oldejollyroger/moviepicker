...
const translations = {
    es: { settings: "Ajustes", watchedList: "Películas Vistas", unwatch: "Quitar", watchList: "Mi Lista", saveForLater: "Guardar", removeFromList: "Quitar", installApp: "Instalar App", installInstructions: "Para instalar, presiona el ícono de Compartir y luego 'Agregar a la pantalla de inicio'", title: 'Movie Randomizer', subtitle: '¿Qué vemos esta noche?', advancedFilters: 'Filtros Avanzados', clearFilters: 'Limpiar Filtros', showFilters: 'Más Filtros', hideFilters: 'Ocultar Filtros', applyFilters: 'Aplicar Filtros', sortBy: 'Ordenar por:', sortOptions: [ { name: 'Popularidad', id: 'popularity.desc' }, { name: 'Mejor Calificación', id: 'vote_average.desc' }, { name: 'Fecha de Estreno', id: 'primary_release_date.desc' } ], region: 'País:', selectRegionPrompt: 'Por favor, selecciona tu país para empezar', platform: 'Plataformas (Opcional):', platformSearchPlaceholder: 'Buscar plataforma...', includeGenre: 'Incluir Géneros:', excludeGenre: 'Excluir Géneros:', decade: 'Década:', allDecades: 'Cualquiera', minRating: 'Calificación Mínima:', surpriseMe: '¡Sorpréndeme!', goBack: 'Atrás', searching: 'Buscando...', searchPlaceholder: 'O busca una película específica...', welcomeMessage: "¡Ajusta los filtros y haz clic en '¡Sorpréndeme!' para descubrir una película!", noMoviesFound: 'No se encontraron películas con los filtros actuales. ¡Prueba con otros!', cardYear: 'Año:', cardDuration: 'Duración:', cardRating: 'Nota TMDb:', cardDirector: 'Director:', cardGenres: 'Géneros:', cardAvailableOn: 'Disponible en (Suscripción):', cardAvailableToRent: 'Disponible para Alquilar:', cardAvailableToBuy: 'Disponible para Comprar:', cardStreamingNotFound: 'No encontrado en streaming.', cardCast: 'Reparto Principal:', cardCastNotFound: 'Reparto no disponible.', cardMarkAsWatched: "Visto", cardTrailer: 'Ver Tráiler', cardTrailerNotFound: 'Tráiler no disponible.', cardSimilarMovies: 'Películas Similares', footer: 'Datos de películas cortesía de', shareButton: 'Compartir', shareSuccess: '¡Enlace copiado!', clearAllFilters: 'Limpiar todos los filtros', details: "Details", quickFilters: 'Filtros Rápidos', contentRating: 'Clasificación por Edad', maxDuration: 'Duración Máxima', popularity: 'Popularidad', indie: 'Gema Oculta', mainstream: 'Éxito de Taquilla' },
    en: { settings: "Settings", watchedList: "Watched List", unwatch: "Un-watch", watchList: "My List", saveForLater: "Save for Later", removeFromList: "Remove", installApp: "Install App", installInstructions: "To install, tap the Share icon and then 'Add to Home Screen'", title: 'Movie Randomizer', subtitle: "What should we watch tonight?", advancedFilters: 'Advanced Filters', clearFilters: 'Clear Filters', showFilters: 'More Filters', hideFilters: 'Hide Filters', applyFilters: 'Apply Filters', sortBy: 'Sort by:', sortOptions: [ { name: 'Popularity', id: 'popularity.desc' }, { name: 'Top Rated', id: 'vote_average.desc' }, { name: 'Release Date', id: 'primary_release_date.desc' } ], region: 'Country:', selectRegionPrompt: 'Please select your country to begin', platform: 'Platforms (Optional):', platformSearchPlaceholder: 'Search platform...', includeGenre: 'Include Genres:', excludeGenre: 'Exclude Genres:', decade: 'Decade:', allDecades: 'Any', minRating: 'Minimum Rating:', surpriseMe: 'Surprise Me!', goBack: 'Back', searching: 'Searching...', searchPlaceholder: 'Or search for a specific movie...', welcomeMessage: "Adjust the filters and click 'Surprise Me!' to discover a movie!", noMoviesFound: 'No movies found with the current filters. Try changing them!', cardYear: 'Year:', cardDuration: 'Duration:', cardRating: 'TMDb Rating:', cardDirector: 'Director:', cardGenres: 'Genres:', cardAvailableOn: 'Available on (Subscription):', cardAvailableToRent: 'Available to Rent:', cardAvailableToBuy: 'Available to Buy:', cardStreamingNotFound: 'Not found on streaming.', cardCast: 'Main Cast:', cardCastNotFound: 'Cast not available.', cardMarkAsWatched: "Watched", cardTrailer: 'Watch Trailer', cardTrailerNotFound: 'Trailer not available.', cardSimilarMovies: 'Similar Movies', footer: 'Movie data courtesy of', shareButton: 'Share', shareSuccess: 'Link Copied!', clearAllFilters: 'Clear All Filters', details: "Details", quickFilters: 'Quick Filters', contentRating: 'Content Rating', maxDuration: 'Max Duration', popularity: 'Popularity', indie: 'Hidden Gem', mainstream: 'Blockbuster' }
};
...
// All components from here on are the complete and final versions
...
const SettingsDropdown = ({ mode, setMode, accent, setAccent, language, setLanguage, t, openWatchedModal, openWatchlistModal }) => {
                ...
                <div className="absolute right-0 mt-2 w-64 bg-[var(--color-card-bg)] rounded-xl shadow-2xl border border-[var(--color-border)] z-30">
                    <div className="p-4">
                        ...
                        <div className="space-y-4">
                             <div className="flex items-center justify-center gap-2 bg-[var(--color-bg)] p-2 rounded-full overflow-hidden">{ACCENT_COLORS.map(colorOption => (<button key={colorOption.name} onClick={() => setAccent(colorOption)} className={`w-6 h-6 rounded-full transition-transform duration-150 ${accent.name === colorOption.name ? 'scale-125 ring-2 ring-offset-2 ring-offset-[var(--color-bg)] ring-[var(--color-accent)]' : ''}`} style={{backgroundColor: colorOption.color}} title={colorOption.name}></button>))}</div>
                            ...
                            <button onClick={openWatchlistModal} className="w-full p-2 text-sm text-left bg-[var(--color-bg)] rounded-lg hover:bg-[var(--color-border)] transition-colors flex items-center gap-2">
...
const WatchedMoviesModal = ({ isOpen, close, watchedMovies, handleUnwatchMovie, t }) => {
    ...
    const watchedArray = Object.values(watchedMovies);
        ...
        <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50 p-4" onClick={close}>
            <div className="bg-[var(--color-card-bg)] rounded-xl max-w-lg w-full max-h-[90vh] flex flex-col border border-[var(--color-border)] shadow-2xl" onClick={(e) => e.stopPropagation()}>
                <div className="p-6 border-b border-[var(--color-border)] flex justify-between items-center">
                    ...
                    <button onClick={close} className="text-gray-400 hover:text-white"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg></button>
                </div>
                <div className="p-6 overflow-y-auto space-y-4">
                    {watchedArray.length > 0 ? (
                        watchedArray.map((movie) => (
                             <div key={movie.id} className="flex items-center justify-between bg-[var(--color-bg)] p-2 rounded-lg">
                                <div className="flex items-center gap-3 overflow-hidden">
                                    <img src={movie.poster ? `${TMDB_THUMBNAIL_BASE_URL}${movie.poster}` : 'https://placehold.co/92x138/4A5568/FFFFFF?text=?'} alt={movie.title} className="w-10 h-auto rounded-md flex-shrink-0" />
                                    <span className="text-sm truncate">{movie.title}</span>
                                </div>
                                <button onClick={() => handleUnwatchMovie(movie.id)} className="text-xs bg-red-600 text-white font-bold py-1 px-3 rounded-full hover:bg-red-700 transition-colors flex-shrink-0">
                                    {t.unwatch}
                                </button>
                            </div>
                        ))
...
const WatchlistModal = ({ isOpen, close, watchlist, handleToggleWatchlist, t }) => {
    if (!isOpen) return null;
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50 p-4" onClick={close}>
            <div className="bg-[var(--color-card-bg)] rounded-xl max-w-lg w-full max-h-[90vh] flex flex-col border border-[var(--color-border)] shadow-2xl" onClick={(e) => e.stopPropagation()}>
                <div className="p-6 border-b border-[var(--color-border)] flex justify-between items-center">
                    <h2 className="text-2xl font-semibold text-[var(--color-accent-text)]">{t.watchList}</h2>
                    <button onClick={close} className="text-gray-400 hover:text-white"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" /></svg></button>
                </div>
                <div className="p-6 overflow-y-auto space-y-4">
                    {watchlistArray.length > 0 ? (
                        watchlistArray.map((movie) => (
                             <div key={movie.id} className="flex items-center justify-between bg-[var(--color-bg)] p-2 rounded-lg">
                                ...
                                <button onClick={() => handleToggleWatchlist(movie)} className="text-xs bg-gray-600 text-white font-bold py-1 px-3 rounded-full hover:bg-gray-700 transition-colors flex-shrink-0">
                                    {t.removeFromList}
                                </button>
                            </div>
                        ))
                    ...
                    <div className="overflow-y-auto">
                        <div className="sm:grid sm:grid-cols-3 sm:gap-x-8 p-6">
                         ...
                         <div className="p-4 sm:p-6 bg-[var(--color-bg)]/50 border-t border-[var(--color-border)]">
                            <h3 className="text-xl font-semibold text-[var(--color-accent-text)] mb-3">Known For</h3>
...
const FilterModal = ({ isOpen, close, handleClearFilters, filters, handleGenreChange, handlePlatformChange, t, genresMap, platformOptions, platformSearchQuery, handlePlatformSearchChange }) => {
    if (!isOpen) return null;
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50 p-4" onClick={close}>
            <div className="bg-[var(--color-card-bg)] rounded-xl max-w-4xl w-full max-h-[90vh] flex flex-col border border-[var(--color-border)] shadow-2xl" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="p-4 mt-auto border-t border-[var(--color-border)] flex justify-end items-center gap-4">
                    <button onClick={handleClearFilters} className="px-6 py-2 bg-gray-600 text-white font-bold rounded-lg shadow-lg hover:bg-gray-500">{t.clearFilters}</button>
...
const App = () => {
  ...
  const WATCHLIST_KEY = 'moviePickerWatchlist_v1';
  ...
  useEffect(() => {
    const fetchLanguageData = async () => {
        ...
        try {
            ...
            const genresData = await fetchApi('genre/movie/list', { language: langParam });
            setGenresMap(genresData.genres.reduce((acc, genre) => ({ ...acc, [genre.id]: genre.name }), {}));
            if(selectedMovie) {
                 fetchFullMovieDetails(selectedMovie.id, langParam).then(details => { if (details) setMovieDetails(details); });
            }
  ...
  const fetchNewMovieBatch = useCallback(async () => {
    ...
    const fetchPage = async (voteCount) => {
      ...
      const queryParams = {
        ...
        ...filters.decade !== 'todos' && { 'primary_release_date.gte': `${parseInt(filters.decade)}-01-01`, 'primary_release_date.lte': `${parseInt(filters.decade) + 9}-12-31` },
      };
      ...
      const fetchPromises = sortOptionsForVariety.map(sortBy => {
        ...
        return fetchApi('discover/movie', { ...queryParams, sort_by: sortBy, page: randomPage });
      });

      const results = await Promise.allSettled(fetchPromises);
      return results.reduce((acc, result) => {
        if (result.status === 'fulfilled' && result.value.results) {
          return acc.concat(result.value.results);
        }
        return acc;
      }, []);
    };
    ...
    try {
      ...
      const transformedMovies = uniqueResults
        ...
        .map(movie => ({ id: movie.id.toString(), title: movie.title, synopsis: movie.overview, year: parseInt(movie.release_date.split('-')[0]), imdbRating: movie.vote_average.toFixed(1), genres: movie.genre_ids.map(id => genresMap[id]).filter(Boolean) || ["Unknown"], poster: movie.poster_path, }));
      const unwatchedMovies = transformedMovies.filter(m => !(watchedMovies[m.id] && watchedMovies[m.id] > Date.now()));
    ...
    } catch (err) { console.error("Error discovering movies:", err); setError(err.message); setAllMovies([]); } 
  ...
  useEffect(() => {
    ...
    const fetchRegionPlatforms = async () => { 
        try { 
            const data = await fetchApi('watch/providers/movie', { watch_region: userRegion });
            const flatrateProviders = data.results.filter(p => p.display_priorities?.[userRegion] !== undefined); 
            const regionalProviders = flatrateProviders.sort((a, b) => (a.display_priorities[userRegion]) - (b.display_priorities[userRegion])).map(provider => ({ id: provider.provider_id.toString(), name: provider.provider_name })); setPlatformOptions(regionalProviders); } catch (err) { console.error(err); setPlatformOptions([]); } };
  ...
  useEffect(() => {
    ...
    const searchTimer = setTimeout(async () => {
        try {
            const data = await fetchApi('search/movie', { query: searchQuery, language: language === 'es' ? 'es-ES' : 'en-US' });
            setSearchResults(data.results.slice(0, 5)); 
        } catch (err) { console.error("Search error:", err); setSearchResults([]); } finally { setIsSearching(false); }
    }, 300);
  ...
  useEffect(() => {
    ...
    const fetchFullMovieDetails = useCallback(async (movieId, lang) => {
        try {
            const data = await fetchApi(`movie/${movieId}`, { language: lang, append_to_response: 'credits,videos,watch/providers'});
            let recommendations = [];
            ...
            if (data.belongs_to_collection) {
                const collectionData = await fetchApi(`collection/${data.belongs_to_collection.id}`, { language: lang });
                addMovies(collectionData.parts.sort((a,b) => b.popularity - a.popularity));
            }
            const director = data.credits?.crew?.find(p => p.job === 'Director');
            if (director) {
                 const directorMoviesData = await fetchApi('discover/movie', { language: lang, with_crew: director.id, sort_by: 'popularity.desc' });
            ...
            if (leadActors?.length > 0) {
                const actorMoviesData = await fetchApi('discover/movie', { language: lang, with_cast: leadActors.join('|'), sort_by: 'popularity.desc' });
                addMovies(actorMoviesData.results);
            }
            if (recommendations.length < 15) {
                const [similarData, genreData] = await Promise.all([
                    fetchApi(`movie/${movieId}/similar`, { language: lang }),
                    fetchApi('discover/movie', { language: lang, with_genres: data.genres.map(g => g.id).join(','), sort_by: 'popularity.desc'})
                ]);
                if (similarData.results) addMovies(similarData.results);
                if (genreData.results) addMovies(genreData.results);
            }
  ...
  useEffect(() => {
    ...
    if (storedWatched) { try { const parsed = JSON.parse(storedWatched); const now = Date.now(); const validWatched = {}; for (const id in parsed) { if (parsed[id].expiry > now) { validWatched[id] = parsed[id]; } } setWatchedMovies(validWatched); } catch (e) { console.error("Could not parse watched movies from localStorage", e); } }
    
    const storedWatchlist = localStorage.getItem(WATCHLIST_KEY);
    if (storedWatchlist) {
        try {
            setWatchList(JSON.parse(storedWatchlist));
        } catch(e) { console.error("Could not parse watchlist from localStorage", e); }
    }
  }, []);
  useEffect(() => {
  ...
  const handleMarkAsWatched = (movie) => {
    ...
    setWatchedMovies(prev => ({...prev, [movie.id]: { id: movie.id, title: movie.title, poster: movie.poster, expiry: Date.now() + threeMonths }})); 
    setAllMovies(prev => prev.filter(m => m.id !== movie.id));
    handleToggleWatchlist(movie); // Also remove from watchlist if it exists there
    handleSurpriseMe(); 
  };
  const handleToggleWatchlist = (movie) => {
        setWatchList(current => {
            const newWatchlist = { ...current };
            if (newWatchlist[movie.id]) {
                delete newWatchlist[movie.id];
            } else {
                newWatchlist[movie.id] = { id: movie.id, title: movie.title, poster: movie.poster };
            }
            return newWatchlist;
        });
    };
  ...
  const handleSimilarMovieClick = async (movie) => {
    setIsActorModalOpen(false); // Close actor modal if open
    setModalMovie(null); // Clear previous similar movie
    ...
    <div className="min-h-screen p-4 font-sans app-container relative">
        ...
        <div className="max-w-3xl mx-auto mb-8 p-4 bg-[var(--color-card-bg)] rounded-xl shadow-lg border border-[var(--color-border)]">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <button onClick={openFilterModal} className="w-full sm:col-span-1 p-2 filter-button text-[var(--color-text-primary)] font-semibold rounded-lg transition-colors flex items-center justify-center gap-2">
                ...
                <div className="sm:grid sm:grid-cols-3 sm:gap-x-8">
                    ...
                    <div className="sm:col-span-2 p-4 sm:p-6 sm:pl-0">
                        ...
                        <div className="mt-6 flex flex-col sm:flex-row gap-4">
                           <button onClick={() => handleMarkAsWatched(selectedMovie)} className="w-full py-3 px-4 bg-red-600/80 hover:bg-red-600 text-white font-bold rounded-lg shadow-md transition-colors flex items-center justify-center gap-2">
                             <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M10 12a2 2 0 100-4 2 2 0 000 4z" /><path fillRule="evenodd" d="M.458 10C3.732 4.943 9.522 3 10 3s6.268 1.943 9.542 7c-3.274 5.057-9.064 7-9.542 7S3.732 15.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clipRule="evenodd" /></svg>
                             {t.cardMarkAsWatched}
                           </button>
                           <button onClick={() => handleToggleWatchlist(selectedMovie)} className="w-full py-3 px-4 bg-sky-600/80 hover:bg-sky-600 text-white font-bold rounded-lg shadow-md transition-colors flex items-center justify-center gap-2">
                              {watchList[selectedMovie.id] ? 
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-3.13L5 18V4z" /></svg> :
                        ...
                        <div className="mt-6 pt-4 border-t border-[var(--color-border)]">
                             ...
                             <MovieCardContent movie={selectedMovie} details={movieDetails} isFetching={isFetchingDetails} t={t} userRegion={userRegion} handleActorClick={handleActorClick} />
                        </div>
                    </div>
                </div>
        ...
        <FilterModal isOpen={isFilterModalOpen} close={closeFilterModal} handleClearFilters={handleClearFilters} filters={filters} handleGenreChange={handleGenreChange} handlePlatformChange={handlePlatformChange} t={t} genresMap={genresMap} platformOptions={platformOptions} platformSearchQuery={platformSearchQuery} handlePlatformSearchChange={handlePlatformSearchChange} />
        ...
        <WatchlistModal isOpen={isWatchlistModalOpen} close={closeWatchlistModal} watchlist={watchList} handleToggleWatchlist={handleToggleWatchlist} t={t} />
                ...
                <div className="bg-[var(--color-card-bg)] rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto relative" onClick={(e) => e.stopPropagation()}>
                    ...
                    {isFetchingModalDetails ? <div className="h-96 flex items-center justify-center"><div className="loader"></div></div> : (
                        <div className="sm:grid sm:grid-cols-3 sm:gap-x-8 p-6">
                            ...
                            <div className="sm:col-span-2 mt-4 sm:mt-0">
                                <h2 className="text-3xl sm:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[var(--color-accent-gradient-from)] to-[var(--color-accent-gradient-to)] mb-3 break-words">{modalMovie.title}</h2>
