...
// HIGHLIGHT: Added new key for the welcome message
const translations = {
    es: {
...
const App = () => {
  ...
  // HIGHLIGHT: New state to track if a search has been performed
  ...
  }, [filters, language, userRegion, genresMap]);
