  ...
  useEffect(() => {
    const initializeApp = async () => {
        if (typeof TMDB_API_KEY === 'undefined' || !TMDB_API_KEY || TMDB_API_KEY === 'YOUR_TMDB_API_KEY_HERE') {
            setError("API Key not found. Please check config.js and deployment secrets.");
            setIsLoading(false);
            return;
        }
