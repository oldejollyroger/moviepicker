...
const App = () => {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-8 font-sans app-container relative">
      {/* HIGHLIGHT: Responsive header buttons */}
      ...
      {/* HIGHLIGHT: Responsive header padding */}
      ...
      {isFiltersVisible && (
        <div className="mb-8 p-6 bg-[var(--color-header-bg)] rounded-xl shadow-2xl">
          ...
          {/* HIGHLIGHT: Responsive grid for filters */}
          ...
          <div ref={cardRef} className="max-w-4xl mx-auto bg-[var(--color-card-bg)] rounded-xl shadow-2xl overflow-hidden mb-10">
              <div className="flex flex-col sm:flex-row">
                  ...
                  <div className="p-6 sm:p-8 sm:w-2/3">
                      ...
                      {/* HIGHLIGHT: Responsive action buttons */}
              ...
              <div className="p-6 bg-[var(--color-bg)] border-t border-[var(--color-border)]">
                  ...
                  {isFetchingDetails ? <div className="flex justify-center"><div className="small-loader"></div></div> :  movieDetails.similar?.length > 0 ? ( 
                      // HIGHLIGHT: Responsive similar movies grid
