...
const App = () => {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-8 font-sans app-container relative">
      ...
      {isFiltersVisible && (
        <div className="mb-8 p-6 bg-[var(--color-header-bg)] rounded-xl shadow-2xl fade-in">
